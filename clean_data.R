...
hh<-dplyr::select(hh,HH1,HH2,HC1A,HC1B,HC2,HH7,HH6,helevel,HHSEX,HH17,PSU,stratum)
hh$HH<-paste(hh$HH1,hh$HH2,sep = "_")
sum(duplicated(hh$HH))

wm<-read_dta("D:\\tang_data\\wm.dta")
wm<-dplyr::select(wm,LN,HH1,CM11,DB2,CM8,HH2,MA1,WM6Y,WB5,WB6A,WB6B,MT1,MT2,MT3,MT4,MT5,
                  welevel,insurance,wscoreu,wscorer,CM11,WB18,WM14,WM15,WB3Y,WB4,WDOBLC,MN2,MN5,windex5,
                  MN20,PN5,PN17,WM15,MN19A,MN19C,MN19D,MN19F,MN19G,MN19H,MN19X,MN19Y,PN9,PN20,PN25A,PN25B,PN25C,CM17,wmweight)
